...
// Linea_Sepolia v3 addresses
const Linea_Sepolia_V3_CORE_FACTORY_ADDRESSES = '0x5223a009d5aA399a0eD6662DC07bA08F7BD38325'
const Linea_Sepolia_V3_MIGRATOR_ADDRESSES = '0xdBd551723c046223021BBF51f4AB09f58Dac5939'
const Linea_Sepolia_MULTICALL_ADDRESS = '0xE7eD25b9D00D86f16d494334756738F9a2b2411A'
const Linea_Sepolia_QUOTER_ADDRESSES = '0x86818A99fBE120053049FC0045F3aF6Fb297F3C7'
const Linea_Sepolia_NONFUNGIBLE_POSITION_MANAGER_ADDRESSES = '0x094e62f302445Ce06d01F76518194BEc5400f009'
...
export function PERMIT2_ADDRESS(chainId: SupportedChainId | undefined): string {
  ...
  if (chainId == SupportedChainId.LINEA_SEPOLIA){
    return "0x186a21FD9deC5fb83b4969df933A9A0f4e878002"
  }
